...
function Item({ Icon = FaRegClock, title = "" }) {
  return (
    <div className="flex w-full items-center gap-3 rounded-[12px] bg-gradient-to-tl from-[#584910] to-[#776F4A] px-7 py-4 text-white transition hover:-rotate-3 md:max-w-[320px]">
      <div>
