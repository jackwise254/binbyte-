...
export default function ServiceCard({
  ...
  return (
    <div className="flex max-w-[347px] flex-col items-center gap-6 rounded-3xl bg-white p-8 shadow-[0_24px_32px_-3px_rgba(3,9,50,0.04)] transition hover:rotate-3 hover:scale-105">
      ...
      {/* <Button title="Get a Quote" className="w-full bg-gradient-to-tl from-[#584910] to-[#776F4A]" Icon={FaWhatsapp} /> */}
      <Button
  title="Get a Quote"
  className="w-full bg-gradient-to-tl from-[#584910] to-[#776F4A]"
  Icon={FaWhatsapp}
  onClick={() => window.open(`https://wa.me/254798969800`, '_blank')}
 />
